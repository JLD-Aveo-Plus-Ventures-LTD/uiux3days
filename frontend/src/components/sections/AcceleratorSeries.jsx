    ...
    return (
        <section className="accelerator-series" id="accelerator-series">
            <div className="accelerator-series-inner">
                <h2>What Is The 5-Day Tech Accelerator Series?</h2>
                <p>
                    This is an intensive, practical, and career-oriented masterclass series designed for ambitious individuals who want to break into tech — fast and correctly. Each skill is taught in its own focused 5-Day Masterclass:
                </p>
